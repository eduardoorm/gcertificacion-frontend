...
import { RootState, getClasesInduccionByTrabajador, useAppDispatch, useAppSelector } from '../../../store';
...
export default function ViewTrabajadorInduccion() {
    ...
    React.useEffect(() => {
        dispatch(getClasesInduccionByTrabajador(auth()?.id_trabajador || '0'))
    }, []);
    ...
    useAPIData(examenesAzarReducer, React.useMemo(() => ({
        onFulfilled: (data: ExamenAzar[]) => {
            ...
            if( data[0].tipo === TIPO_CLASE.INDUCCION && data[0].respuestas_correctas + data[0].respuestas_incorrectas > 0){
                let data_ = {...data[0]};
                setExamenAzar(data_);
    ...
    return (
        <Box component="main">
            ...
            <Dialog keepMounted open={openDialogResult} onClose={handleCloseDialogResult}>
                ...
                <DialogActions>
                    <Button onClick={() => setOpenDialogResult(false)}>Cerrar</Button>
                </DialogActions>
            </Dialog>
            ...
            <Box>
                <Alert variant='outlined' severity="info">
                    ...
                    Usted ya ha realizado exitosamente esta inducci&oacute;n
                </Alert>
            ...
            <Box>
                <Alert variant='outlined' severity="warning">
                    ...
                    Usted ya ha realizado esta inducci&oacute;n y ha alcanzado la cantidad m&aacute;xima de intentos para aprobar el examen.
                </Alert>
            </Box>
            }
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <Typography variant='body2' color='text.seconday'>
                        <InfoIcon />{' '}
                        Recuerde que debe visualizar el video completo para rendir el examen.
                    </Typography>
                </CardContent>
            </Card>
            <Stepper activeStep={activeStep} orientation="vertical" sx={{mt: 5}}>
                <Step key='paso.1'>
                    ...
                    <StepContent>
                        <Typography>Pulse el botón para iniciar con la inducción</Typography>
                        <Box sx={{ mb: 2 }}>
                            <div>
                                <Button
                                    variant="contained"
                    ...
                    <StepContent sx={{backgroundColor: 'white', p: 3, borderRadius: 2}}>
                        ...
                        <Box sx={{ mt: 4, mb: 2, visibility: respuestasElegidas.length < preguntas.length ? 'hidden' : 'visible' }}>
                            <div>
                                ...
                                {justSolved && examenAzar.numero_intento < 2 && examenAzar.aprobado === EXAMEN_APROBADO.RECHAZADO &&
                                <Button sx={{mt: 1, mr: 1}} 
                                    variant='contained'
